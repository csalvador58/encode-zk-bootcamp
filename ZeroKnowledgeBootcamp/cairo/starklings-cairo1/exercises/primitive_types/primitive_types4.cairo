...
fn convert_to_felt(x: u8) -> felt252 {
    ...
    let x_to_felt: felt252 = x.into();
    x_to_felt
}

fn convert_felt_to_u8(x: felt252) -> u8 {
    //TODO return x as a u8.
    let x_to_u8: u8 = x.try_into().unwrap();
    x_to_u8
}
...
fn test_convert_to_felt() {
    assert(convert_to_felt(1_u8) == 1_felt252, 'Type conversion went wrong');
}

#[test]
fn test_convert_to_u8() {
    assert(convert_felt_to_u8(1_felt252) == 1_u8, 'Type conversion went wrong');
}
